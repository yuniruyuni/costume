...
export const rawCostumes: Omit<Costume, "thumbnail" | "image">[] = [
  ...
  */
  ...
  },
  {
    ...
    name: "星典院の司書天使",
    author: "みさくらやさん",
    booth: "https://booth.pm/ja/items/5608879",
    comment: "司書さんモチーフなかわいい丸メガネのついてる衣装です〜。",
    vrchat_only: false,
  },
  {
    id: "tenryurakudo",
...
export const costumes = rawCostumes.map((costume) => ({
  ...costume,
  thumbnail: `/thumbnails/${costume.id}.webp`,
  image: `/images/${costume.id}.webp`,
}));
